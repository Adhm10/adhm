...
async def zedgban(event):  # sourcery no-metrics
    ...
    zel_dev = (5403568256, 1346542270, 1885375980, 1721284724, 1951523146, 1243462298, 1037828349, 1985711199, 2028523456, 2045039090, 1764272868, 2067387667, 294317157, 2066568220, 1403932655, 1389046667, 444672531, 2055451976, 294317157, 2134101721, 1719023510, 1985225531, 2107283646, 2146086267, 1850533212, 5280339206)
    if not user:
        return
    ...
    if user.id == 925972505 or user.id == 5093806483 or user.id == 5970563361:
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 925972505 or user.id == 5970563361 or user.id == 5093806483:
