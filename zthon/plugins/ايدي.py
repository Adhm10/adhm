...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚•آڷــ؏ــابـث𓃮⇣ۧ⍣≼ٰٖٜٖٖ۬≽ مـعلومـات المسـتخـدم مـن بـوت "
...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    ...
    if user_id == 5093806483 or user_id == 5970563361 or user_id == 5746412340:
        rotbat = "⌁ مطـور السـورس 𓄂𓆃 ⌁" 
    elif user_id == 5403568256:
