...
async def _ban_person(event):
    ...
    if user.id == 5403568256 or user.id == 5093806483 or user.id == 5970563361:
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 5093806483 or event.chat_id == 5970563361 or event.chat_id == 5746412340:
        ...
        if user.id == 5093806483 or user.id == 5970563361 or user.id == 5746412340:
